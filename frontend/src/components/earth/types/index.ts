...
export interface FlyToTarget {
  ...
  duration?: number;
  /**
   * rotateThenZoom — orbit to face the destination at current altitude, then dolly in.
   * Avoids cutting through the planet when going halfway around the globe.
   */
  approach?: "direct" | "rotateThenZoom";
}
