...
export const CAMERA_MIN_DISTANCE = 10 / 6_371_000; // ~10 m AGL
export const CAMERA_MAX_DISTANCE = 14; // deep space — sun + outer planets
...
> = {
  ultra: {
    ...
    // Cap GPU maps — full 8K mip chains were OOM-killing Chrome
    textureMaxSize: 2048,
    maxTileRadius: 2,
    maxBuildings: 400,
  },
